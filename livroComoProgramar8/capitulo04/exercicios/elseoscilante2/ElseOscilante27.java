/*
 * 4.27-2 (Problema do else oscilante) Determine a saída para cada 
 ...
 */
package exercicios.elseoscilante2;
...
public class ElseOscilante27 {
   public static void main(String[] args) {
      ...
      if (x < 10) {
         if (y > 10) // if se s
            System.out.println("*****");
      } else { // else pertence ao if de x < 10
         System.out.println("#####"); // pertence a else
         System.out.println("$$$$$"); // pertence a else
      } // end else
